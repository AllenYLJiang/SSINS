...
from similarity_module.torchreid import metrics
...
from similarity_module.torchreid.losses import DeepSupervision
    ...
    def _evaluate(
        ...
        def _feature_extraction(data_loader):
            ...
            for batch_idx, data in enumerate(data_loader):
                ...
                # imgs = torch.from_numpy(np.ones((300, 3, 256, 128)).astype('float32'))
                if self.use_gpu:
                    imgs = imgs.cuda()
                end = time.time()
