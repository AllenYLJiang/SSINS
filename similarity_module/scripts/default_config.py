...
def get_default_config():
    ...
    cfg.model.load_similarity_weights = '' # path to model weights
    ...
    cfg.test.evaluate_similarity_module = False # test only
...
def engine_run_kwargs(cfg):
    return {
        ...
        'test_only': cfg.test.evaluate_similarity_module,
